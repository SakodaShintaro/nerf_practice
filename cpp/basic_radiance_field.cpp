...
std::pair<torch::Tensor, torch::Tensor> BasicRadianceFieldImpl::forward(torch::Tensor x, torch::Tensor d) {
...
torch::Tensor BasicRadianceFieldImpl::gamma(torch::Tensor p, int32_t L) {
  p = torch::tanh(p);
